...
"""
"""
<plugin key="VRPLite" name="AC Remote 2 switches Blind LITE" author="Erwanweb" version="0.0.2" externallink="https://github.com/Erwanweb/VRPLite.git">
    <description>
        <h2>Control of cabled blinds using relay of smart implant for CASA-IA</h2><br/>
        Easily control cabled blinds with smar implant<br/>
